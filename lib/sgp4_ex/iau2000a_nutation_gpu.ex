defmodule Sgp4Ex.IAU2000ANutationGPU do
  ...
  # Fundamental arguments coefficients - 5 standard arguments 
  # Load the same coefficients as CPU version and stay in tensor land
  @fa0_5 Sgp4Ex.IAU2000ACoefficients.fa0()
         |> Nx.squeeze()
         |> Nx.slice([0], [5])
         |> Nx.as_type(:f64)
  @fa1_5 Sgp4Ex.IAU2000ACoefficients.fa1()
         |> Nx.squeeze()
         |> Nx.slice([0], [5])
         |> Nx.as_type(:f64)
  @fa2_5 Sgp4Ex.IAU2000ACoefficients.fa2()
         |> Nx.squeeze()
         |> Nx.slice([0], [5])
         |> Nx.as_type(:f64)
  @fa3_5 Sgp4Ex.IAU2000ACoefficients.fa3()
         |> Nx.squeeze()
         |> Nx.slice([0], [5])
         |> Nx.as_type(:f64)
  @fa4_5 Sgp4Ex.IAU2000ACoefficients.fa4()
         |> Nx.squeeze()
         |> Nx.slice([0], [5])
         |> Nx.as_type(:f64)
  ...
  defnp fundamental_arguments_gpu(t) do
    # Use 5-element versions to match CPU implementation
    args = @fa4_5 * t
    args = (args + @fa3_5) * t
    args = (args + @fa2_5) * t
    args = (args + @fa1_5) * t

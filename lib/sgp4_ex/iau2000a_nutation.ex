defmodule Sgp4Ex.IAU2000ANutation do
  ...
  @lunisolar_lon_coeffs Sgp4Ex.IAU2000ACoefficients.lunisolar_longitude_coefficients() |> Nx.to_list()
  @lunisolar_obl_coeffs Sgp4Ex.IAU2000ACoefficients.lunisolar_obliquity_coefficients() |> Nx.to_list()

  @planetary_arg_mult Sgp4Ex.IAU2000ACoefficients.planetary_arg_multipliers() |> Nx.to_list()
  @planetary_lon_coeffs Sgp4Ex.IAU2000ACoefficients.planetary_longitude_coefficients() |> Nx.to_list()
  @planetary_obl_coeffs Sgp4Ex.IAU2000ACoefficients.planetary_obliquity_coefficients() |> Nx.to_list()
  ...
  defp calculate_planetary_nutation(t) do
    ...
    dpsi_pl = Nx.add(Nx.dot(sin_args, lon_coeffs_687[[.., 0]]), 
                     Nx.dot(cos_args, lon_coeffs_687[[.., 1]]))
    
    deps_pl = Nx.add(Nx.dot(sin_args, obl_coeffs_687[[.., 0]]), 
  ...
  defp equation_of_equinoxes_gpu(jd_tt) do
    ...
    {dpsi, _deps} = Sgp4Ex.IAU2000ANutationGPUV2.iau2000a_nutation_gpu(jd_tt)
